...
ifndef _INCLUDE_USES_AUTORECONF_MK
...
ifndef _INCLUDE_USES_AUTORECONF_POST_MK
...
ifdef libtool_ARGS
ifeq ($(call find-uses-arg,build,$(libtool_ARGS)),)
BUILD_DEPENDS		+= libtoolize:devel/libtool
endif
endif

ifeq ($(autoreconf_ARGS),)
...
else ifneq ($(filter-out build,$(call remove-comma,$(autoreconf_ARGS))),)
